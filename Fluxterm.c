...
DEFINE_UDS_FLUX(massflux_plus_diffusiveflux,f,t,i)
{
 ...
 if (BOUNDARY_FACE_THREAD_P(t)) /*Most face values will be available*/
  ...
  else
    {
      ...
      NV_DS(psi_vec,  =, C_U(c0,t0),C_V(c0,t0),C_W(c0,t0),*,C_R(c0,t0),+,C_YI_G(c0,t0,i),*,C_R(c0,t0),*,C_DIFF_EFF(c0,t0,i),*,-1);
      NV_DS(psi_vec, +=, C_U(c1,t1),C_V(c1,t1),C_W(c1,t1),*,C_R(c1,t1),+,C_YI_G(c1,t1,i),*,C_R(c1,t1),*,C_DIFF_EFF(c1,t1,i),*,-1);
